...
def ResNet50V2(
  ...
  def stack_fn(x):
    x = resnet.stack2(x, base_channel*1, 3, name='conv2')
    x = resnet.stack2(x, base_channel*2, 4, name='conv3')
    x = resnet.stack2(x, base_channel*4, 6, name='conv4')
    return resnet.stack2(x, base_channel*8, 3, stride1=1, name='conv5')
...
def ResNet101V2(
  ...
  def stack_fn(x):
    x = resnet.stack2(x, base_channel*1, 3, name='conv2')
    x = resnet.stack2(x, base_channel*2, 4, name='conv3')
    x = resnet.stack2(x, base_channel*4, 23, name='conv4')
    return resnet.stack2(x, base_channel*8, 3, stride1=1, name='conv5')
...
def ResNet152V2(
  ...
  def stack_fn(x):
    x = resnet.stack2(x, base_channel*1, 3, name='conv2')
    x = resnet.stack2(x, base_channel*2, 8, name='conv3')
    x = resnet.stack2(x, base_channel*4, 36, name='conv4')
    return resnet.stack2(x, base_channel*8, 3, stride1=1, name='conv5')
